...
import { FaHome, FaInbox, FaCompass, FaBell, FaBars, FaClock } from 'react-icons/fa';
  ...
  return (
    ...
    <main className="bg-gradient-to-b from-purple-200 via-white to-white min-h-screen">
      <header className="flex justify-between items-center p-4">
        ...
        {/* <p className="text-sm text-gray-600">Rajkot<DropdownMenu.TriggerIcon />
          <br /><span className="text-xs">within 20 miles</span>
        </p> */}
